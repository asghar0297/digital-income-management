            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <a href="{{ route('expense-management.category.create') }}" class="btn btn-primary" >Add {{$title}}</a>
                </div>
                <div class="card-body">
                        ...
                        <table id="example" class="table table-bordered key-buttons text-nowrap border-top0">
                            ...
                            <tbody>
                                @forelse ($models as $key => $model )
                                    <tr>
                                        <td>{{ $key+1 }}</td>
                                        <td>{{ $model->parent_category->category ?? '-' }}</td>
                                        ...
                                        <td class="text-center align-middle">
                                            <div class="btn-group align-top">
                                                ...
                                                <a href="{{ route('expense-management.category.edit',$model->id) }}" class="btn btn-sm btn-primary badge m-1"><i class="fa fa-pencil"></i></a>
                                                {{ Form::open(['route' => ['expense-management.category.destroy',$model->id] ]) }}
                                                    @method('delete')
